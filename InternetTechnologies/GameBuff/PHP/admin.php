...
<head>
  ...
  <title>Update Products | Games Buff UK 2022</title>
        ...
        <div class="col-2">
          <div class="form-container">
            ...
            <form action="process.php" method="POST">
              ...
              <input type="text" name="product_price" value="<?= $price; ?>" placeholder="Product Price">
              <input type="text" name="product_image" value="<?= $location; ?>" placeholder="Image Location">
              <?php
                if ($update == true):
              ?>
              ...
              <?php endif; ?>
              <p style="text-align: center;">Click here to <a href="updateUsers.php">update users</a></p>
            </form>
          </div>
        </div>
      </div>
