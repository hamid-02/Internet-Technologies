...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/metro/css/theme.css?v=5.1.3&nocache=3243370891ltr&server=1">
    <link rel="stylesheet" type="text/css" href="./themes/metro/css/printview.css?v=5.1.3" media="print" id="printcss">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gamebuff&table=users">`gamebuff`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gamebuff&table=usertable">`gamebuff`.`usertable`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gamebuff&table=products">`gamebuff`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=account&table=products">`account`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=account&table=product_details">`account`.`product_details`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=product_details&table=products">`product_details`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=account&table=usertable">`account`.`usertable`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=account&table=users">`account`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=product_details&table=Products">`product_details`.`Products`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2978295b4c26443d6a7164247c6f602c">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="gamebuff" targettable="users">
